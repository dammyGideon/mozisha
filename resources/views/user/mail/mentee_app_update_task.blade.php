                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="text-center pb25" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:12px; line-height:30px; text-align:left; padding-bottom:25px;"><div mc:edit="text_3">Hi {{$mail_data['name']}},<br/>
                                                                    This is to notify you that {{$mail_data['mentor_name']}} updated a task titled  "{{$mail_data['task_title']}}" that was previously assigned, you can login to your
                                                                    ...
                                                                    <small>Deadline: {{$mail_data['deadline']}}</small><br>
                                                                    <br>
