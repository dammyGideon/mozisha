            ...
            <!-- Chat participant's Name -->
                <div class="media chat-name align-items-center text-truncate">
                    <div class="avatar d-none d-sm-inline-block mr-3 " :class="statusIcon">
                        <img src="https://ui-avatars.com/api/?name={{$connect->mentee->name}}&color=FFFFFF&background=563C5C" alt="">
                    </div>

                    <div class="media-body align-self-center ">
                        <h6 class="text-truncate mb-0">{{$connect->mentee->name}}</h6>
                        <small class="text-muted">
                            {{$connect->mentee->email}}
                        </small>
