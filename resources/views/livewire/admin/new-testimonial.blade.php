        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">New Testimonial</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" wire:submit.prevent="addTestimonial">
                                    ...
                                    <div class="text-right">
                                        <button style="border-color: #420175; background-color: #420175;" type="submit" wire:loading wire:target="addTestimonial" class="btn btn-primary btn-lg"><i class="fa fa-spinner fa-spin"></i> Processing update..</button>
                                        <button class="btn btn-primary btn-lg" wire:loading.remove wire:target="addTestimonial" style="background-color: #420175; border-color: #420175;">Save Testimonial</button>
                                    </div>
                                </form>
                            </div>
                        </div>
