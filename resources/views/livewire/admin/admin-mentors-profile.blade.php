                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('mentors')}}">Mentors</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body alert alert-success" role="alert">
                                                <h5 class="card-title d-flex justify-content-between">
                                                    <span style="font-size: 130%; font-weight: bold; text-align: center;"> >> Business/Mentor Information</span>
                                                </h5>
                                                                    ...
                                                                    <li>
                                                                        <div class="experience-content">
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Company Name</span>
                                                                                   <div class="row-result">{{ $company->name }}</div>
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Industry</span>
                                                                                        <div class="row-result">{{ $company->industry }}</div>
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Official website</span>
                                                                                        <div class="row-result">{{ $company->website }}</div>
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Position</span>
                                                                                <div class="row-result">{{ $company->position }}</div>
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">About Company</span>
                                                                                <div class="row-result">{{ $company->description }}</div>
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Company Attachment</span>
                                                                                @if($about)
                                                                ...
                                                                <ul class="experience-list profile-custom-list">
                                                                    ...
                                                                    <li>
                                                                        <div class="experience-content">
                                                                            ...
                                                                            <div class="timeline-content">
                                                                                ...
                                                                                @if($language)
                                                                                    @foreach($language as $i)
                                                                                        <div class="row-result">{{ $i->language }}</div>
                                                                                    @endforeach
                                                                                @endif
                                                                            </div>
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Offering apprenticeship in</span>
                                                                            ...
                                                                            <hr><br>
                                                                            <div class="timeline-content">
                                                                                <span style="text-decoration: underline; font-weight: bold;">Need help with</span>
