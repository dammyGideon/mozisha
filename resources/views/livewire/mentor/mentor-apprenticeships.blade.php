        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8 col-12">
                    ...
                    @if($apps_no < 2)
                        <h2 class="breadcrumb-title">You have {{$apps_no}} apprenticeship program</h2>
                    @else
                        <h2 class="breadcrumb-title">you have {{$apps_no}} apprenticeship programs</h2>
                    @endif;
                                        ...
                                        <div class="user-info-right">
                                            <div class="user-infos">
                                                <ul>
                                                    ...
                                                    <li><i class="fas fa-edit"></i> Apprenticeship, {{$app->mentor_period}}hrs/wk</li>
                                                    @if($app->type == 'Premium')
                                                        <li>  <i class="fas fa-dollar-sign filled"></i> {{$app->price}} <del> {{$app->price + 200}}</del></li>
                                                    @endif
                                                    <li><i class="far fa-clock"></i>{{strftime("%b", $app->start_timestamp)}}, {{strftime("%Y", $app->start_timestamp)}} - {{strftime("%b", $app->end_timestamp)}}, {{strftime("%Y", $app->end_timestamp)}} </li>
                                                </ul>
                                            </div>
                                            <div class="mentor-booking"  >

                                                <a  href="{{route('mentor.apprenticeship.view', $app->id)}}" class="apt-btn" style="border-color: #420175; background-color: #420175;">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
