...
{{--                                </div>--}}
                            ...
                            <div class="comment-reply">
                                <a class="comment-btn" href="#" wire:click="viewTask({{$task->id}})">
                                    <i wire:loading.remove wire:target="viewTask" class="fa fa-reply"></i> <i wire:loading wire:target="viewTask" class="fa fa-spinner fa-spin"></i> Respond
                                </a>
                                <p class="recommend-btn">
                                    ...
                                    <a class="dislike-btn" data-toggle="modal" href="#mentee_new_meeting">
...
{{--                                        </li>--}}
                        ...
                        <div class="card author-widget clearfix">
                            ...
                            <div class="blog blog-single-post">
                                @if(!$response || $editForm)
                                    @if(!$response)
                                    <h3 class="blog-title" style="text-align: center; color: rgba(187,4,10,0.92);">You haven't provided a solution to this task</h3>
                                    @endif
                                   <hr>
                                    <div class="blog-info clearfix">
                                        <div class="post-left">
                                            <form wire:submit.prevent="addResponse" >
                                                @if($editForm)
                                                    <div class="row form-row">
                                                        <div class="col-12 col-md-12">
                                                            <h4 style="text-align: center;">Update your solution</h4>
                                                        </div>
                                                        <div class="col-12">
                                                ...
                                                @else
                                                    <div class="row form-row">
                                                        <div class="col-12 col-md-12">
                                                            <h4 style="text-align: center;">Submit your solution</h4>
                                                        </div>
                                                        <div class="col-12">

                                                            <small style="text-align: center;" class="form-text text-muted"><b><i>{{$user->name}} will see this response.</i></b></small>
                                                        </div>
                                                    </div>
                                                @endif
                        ...
                        <div class="card blog-share clearfix">
                            ...
                            <div class="card-body">
                                @if($response->file_original_name)
                                    <ul class="social-share">
                                        <a target="_blank" href="{{$response->FilePath}}" title="Facebook"> <li><i class="fa fa-file"></i> {{$response->file_original_name}}</li></a>
                                    </ul>
                                @else
                                    <ul class="social-share">
                                        <li><a target="_blank" href="#" title="Facebook"><i class="fa fa-file"></i></a>  No file Attached.</li>
                            ...
                            <div class="card-body">
                                <ul class="social-share">
                                    <li wire:click="showEditForm"><a  title="Edit your Solution to this task"><i wire:loading.remove wire:target="showEditForm" class="fa fa-edit"></i>  <i wire:loading wire:target="showEditForm" class="fa fa-spinner fa-spin"></i> </a> Edit Response</li>
                                </ul>
                            </div>
                        </div>
                        @endif
                        ...
                        @if($response)
                            <div class="card blog-share clearfix">
                                <div class="card-header">
                                    <h4 class="card-title">Mentor's rating for your solution.</h4>
                                </div>
                                <div class="card-body">
                                    @if($response->rating)
                                    <div class="review-count rating">
                                    ...
                                    @else
                                    <p class="text-danger">Your mentor has not rated your solution.</p>
                                    @endif
                                </div>
